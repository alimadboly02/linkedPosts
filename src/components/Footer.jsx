...
export const MassageLogo = () => {
  return (
<svg className="w-10 h-10 text-blue-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="currentColor" viewBox="0 0 24 24">
...
const Footer = () => {
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="flex justify-center text-sky-600 text-3xl font-bold">
        <div className='flex items-center'>
            <MassageLogo />
            <p className='ml-2'>Linked Posts</p>
        </div>
      
    </div>
        
    <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
      social platform to share posts and connect with others
    </p>
